# TrackTime
Minimal python-based personal time tracking and scheduling app. Currently supporting Windows 11 and Linux.

# Installation

## Linux

Simply allow the *linux.py file execution permissions and run it.
...
For other setups the app might be off center (which can be changed in the source code though)
